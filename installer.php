...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'enchantedforest_dbf93b7dcb86bbf94242_20220224093220_archive.zip';
	const ARCHIVE_SIZE		 = '54027227';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'dbf93b7-24093220';
    const SECONDARY_PACKAGE_HASH = 'd8ef3a4-24093220';
	const VERSION			 = '1.4.4';
